# Note: The CSV generated by this script can be downloaded here : http://www.google.com/fusiontables/DataSource?snapid=S24896800uM
...
task :scrap_irish_convicts => :environment do
  ...
  File.open('irish_convicts.csv', 'w') do |f|
    ...
    convicts_found = 1
    page = 1
    # FIXME this never stops, it seems that if you feed an index to high you continously get the second last page
