...
namespace :seed do
  ...
  task :counties => :environment do
    insert_county(:name => 'Bedfordshire', :country => 'UK')
    insert_county(:name => 'Berkshire', :country => 'UK')
    insert_county(:name => 'Buckinghamshire', :country => 'UK')
    insert_county(:name => 'Cambridgeshire', :country => 'UK')
    insert_county(:name => 'Cheshire', :country => 'UK')
    insert_county(:name => 'Cornwall', :country => 'UK')
    insert_county(:name => 'Cumbria', :country => 'UK')
    insert_county(:name => 'Derbyshire', :country => 'UK')
    ...
    insert_county(:name => 'East Yorkshire', :country => 'UK', :alias => 'Yorkshire')
    insert_county(:name => 'Essex', :country => 'UK')
    insert_county(:name => 'Gloucestershire', :country => 'UK')
    insert_county(:name => 'Greater London', :country => 'UK', :alias => 'London')
    insert_county(:name => 'Hampshire', :country => 'UK')
    insert_county(:name => 'Hertfordshire', :country => 'UK')
    insert_county(:name => 'Huntingdonshire', :country => 'UK')
    insert_county(:name => 'Kent', :country => 'UK')
    insert_county(:name => 'Lancashire', :country => 'UK')
    insert_county(:name => 'Leicestershire', :country => 'UK')
    insert_county(:name => 'Lincolnshire', :country => 'UK')
    insert_county(:name => 'Merseyside', :country => 'UK')
    insert_county(:name => 'Middlesex', :country => 'UK')
    insert_county(:name => 'Norfolk', :country => 'UK')
    insert_county(:name => 'Northamptonshire', :country => 'UK')
    insert_county(:name => 'Northumberland', :country => 'UK')
    insert_county(:name => 'Nottinghamshire', :country => 'UK')
    insert_county(:name => 'Oxfordshire', :country => 'UK')
    insert_county(:name => 'Rutland', :country => 'UK')
    insert_county(:name => 'Shropshire', :country => 'UK')
    insert_county(:name => 'Somerset', :country => 'UK')
    insert_county(:name => 'South Yorkshire', :country => 'UK')
    insert_county(:name => 'Staffordshire', :country => 'UK')
    insert_county(:name => 'Suffolk', :country => 'UK')
    insert_county(:name => 'Surrey', :country => 'UK')
    insert_county(:name => 'Tyne and Wear', :country => 'UK')
    insert_county(:name => 'Warwickshire', :country => 'UK')
    insert_county(:name => 'Westmorland', :country => 'UK')
    insert_county(:name => 'Wiltshire', :country => 'UK')
    insert_county(:name => 'Worcestershire', :country => 'UK')
    ...
    insert_county(:name => 'Glasgow', :country => 'UK')
    insert_county(:name => 'Highland', :country => 'UK')
    ...
    insert_county(:name => 'Renfrewshire', :country => 'UK')
    insert_county(:name => 'Shetland Islands', :country => 'UK')
    insert_county(:name => 'South Ayrshire', :country => 'UK')
    ...
    insert_county(:name => 'Sligo', :country => 'UK')
    insert_county(:name => 'Tipperary', :country => 'UK')
    insert_county(:name => 'Waterford', :country => 'UK')
    insert_county(:name => 'Westmeath', :country => 'UK')
    insert_county(:name => 'Wexford', :country => 'UK')
